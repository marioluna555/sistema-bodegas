    ...
    <form action="${pageContext.request.contextPath}/material" method="post" class="card p-4 shadow-sm">
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="codigoMaterial" class="form-control" >
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="stockDisponible" class="form-control" required>
            </div>

            <div class="col-md-6">
                <label class="form-label">Stock Mínimo</label>
                <input type="text" name="stockMinimo" class="form-control" required>
            </div>

            <div class="col-md-6">
                <label class="form-label">Stock Máximo</label>
                <input type="text" name="stockMaximo" class="form-control" required>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="costoTotal" class="form-control" required>
            </div>
